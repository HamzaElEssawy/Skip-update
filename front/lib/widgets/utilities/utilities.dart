...
class Utilities extends StatelessWidget {
  ...
  final itemsUrls = [
    'assets/utilities/gas.jpg',
    'assets/utilities/water.jpg',
    'assets/utilities/electricity.jpg',
  ];

  final itemsUrls1 = [
    [
      'assets/utilities/gas-logo.jpg',
      'Gas bill',
      '2 MMM 2020 - 3:09 PM',
      '-EGP45.00'
    ],
    [
      'assets/utilities/water-logo.jpg',
      'Water bill',
      '2 MMM 2020 - 3:09 PM',
      '-EGP70.00'
    ],
    [
      'assets/utilities/electricity-logo.jpg',
      'Electricity bill',
      '1 MMM 2020 - 5:09 PM',
      '-EGP50.00'
    ],
  ...
  Widget buildCarouselItem(String itemUrl, int index) => Container(
      ...
      color: Colors.grey,
      width: double.infinity,
      child: Image.asset(itemUrl, fit: BoxFit.cover));
}
