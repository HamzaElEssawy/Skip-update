...
urlpatterns = [
    ...
    # post to send verification code in sms
    path("check_phone",CheckPhone.as_view()),
    path("signup",SignUpView.as_view()),
    # post verification code to verify code
    ...
    # to send money (can be used in 'transfer' and 'scan to pay')
    path("pay/<str:pk>",PaymentView.as_view()),
    path("pay",PaymentView.as_view()),
    # to search user contacts
