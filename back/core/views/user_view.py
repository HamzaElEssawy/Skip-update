...
def send_code(phone, msg):
    ...
    try:
        ...
        # if response.json()["code"] == "4901" or response.json()["code"] == "1901":
...
class CheckPhone (APIView):
    def post (self,request):
        ...
        res = send_code(phone,"use this code to verify your phone number")
        if res == '200':
